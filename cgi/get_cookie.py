...
response_body = [
    ...
    f'<code class="font-bold text-sm bg-slate-800 text-cyan-400 p-3 rounded-full md:text-xl">{value}</code>',
    "</div>",
    '<a href="../cookies.html"class="py-2 px-7 text-center ring-2 ring-cyan-500 rounded-full transition-all duration-300">Back to cookies</a>',
    "</div>",
    "</body>",
    "</html>",
]
